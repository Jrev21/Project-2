...
object Generator {
  ...
  def CreateRow(orderID: Int): List[String] ={
    ...
    //productID
    val productID = Random.nextInt(25)
    //Productname
...
//    val city = getCity()
  ...
  def getPaymentType(): String ={
    val paymentTypes = List("Credit card", "Internet Banking ", "UPI","wallet")
...
//    }
//    val cities = Map(
//      (0,"Madrid"),(1, "New York City"), (2, "London"), (3, "Tokyo"), (4, "Mexico City"), (5, "Toronto"), (5, "Antananarivo"))
//
//    val citynum = Random.nextInt(5)
//    val city = cities(citynum)
//    return city
//  }
