...
object csv {
  val pw = new PrintWriter(new File("C:\\Users\\ortiz\\IdeaProjects\\RevatureGroup2_Project1\\src\\input\\Dataset.csv" ))

  def main(args: Array[String]): Unit ={

    val csv = ListBuffer[List[String]](
      //List contains the headers to begin with then adds as more rows are generated
      List("Order_ID","Customer_ID","Customer_name","Product_ID",
    "Product_name","Product_category","payment_type","qty","price","DateTime","country","city",
  ...
  def CreateRow(orderID: Int): List[String] ={
   ...
   val customerName = getCustomerName(customerID)
    //productID
    val productID = Random.nextInt(10)
    //Productname
  ...
  def getCountry(): String = {
    ...
    val countries = Map(
      (0,"Spain"),(1, "USA"), (2, "England"), (3, "Japan"), (4, "Mexico"), (5, "Canada"), (5, "Madagascar"))

    val countrynum = Random.nextInt(5)
